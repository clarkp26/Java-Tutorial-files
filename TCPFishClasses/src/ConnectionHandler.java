...
//            this.getDate(); 
    ...
    private void getFish() {	// use the date service to get the date
      Fish o = myFish;
      this.send(o);
  }
...
//        {
//      	o = myFish;
//      	System.out.println("\nFish name is: "+ o.getName());
//        System.out.println("\nFish type is: "+ o.getType());
//        }
    }
