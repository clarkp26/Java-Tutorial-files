...
//    }
    private void getFish() {
    	String theFishCommand = "GetFish", Fish;
    	System.out.println("01. -> Sending Command (" + theFishCommand + ") to the server...");
    	this.send(theFishCommand);
    	try{
    		Fish o =  (Fish) receive();
    		System.out.println("05. <- The Server responded with: ");
    		System.out.println("    Fish Type: " + o.getType() + "\n    Fish Name: " + o.getName());
    	}
    	catch (Exception e){
    		System.out.println("XX. There was an invalid object sent back from the server");
    	}
    ...
    {
    	Fish myFish = new Fish("Salmon","Jerry");
